...
bool RainDayTime::init()
{
    ...
    CCFiniteTimeAction* cloud1ActionMoveDone = CCCallFuncN::create( this,callfuncN_selector(RainDayTime::cloudy1SpriteMoveFinished));
    ...
    CCFiniteTimeAction* cloud2ActionMoveDone = CCCallFuncN::create( this,callfuncN_selector(RainDayTime::cloudy2SpriteMoveFinished));
    ...
    CCFiniteTimeAction* cloud3ActionMoveDone = CCCallFuncN::create( this,callfuncN_selector(RainDayTime::cloudy3SpriteMoveFinished));
    ...
    CCFiniteTimeAction* cloud4ActionMoveDone = CCCallFuncN::create( this,callfuncN_selector(RainDayTime::cloudy4SpriteMoveFinished));
...
void RainDayTime::moveBackgroundSprite(CCNode *sender)
{
    int zorder = 0;
    ...
    CCFiniteTimeAction* actionMoveDone = CCCallFuncN::create( this,callfuncN_selector(RainDayTime::moveBackgroundSprite));
...
void RainDayTime::cloudy1SpriteMoveFinished(CCNode *sender)
{
...
void RainDayTime::cloudy2SpriteMoveFinished(CCNode *sender)
{
    CCSprite *cloud1Sprite = (CCSprite *)sender;
    float bgSpritespx = cloud1Sprite->getTextureRect().getMaxX();
    CCSize size = CCDirector::sharedDirector()->getWinSize(); // 屏幕大小
...
void RainDayTime::cloudy3SpriteMoveFinished(CCNode *sender)
{
    CCSprite *cloud1Sprite = (CCSprite *)sender;
    float bgSpritespx = cloud1Sprite->getTextureRect().getMaxX();
    CCSize size = CCDirector::sharedDirector()->getWinSize(); // 屏幕大小
...
void RainDayTime::cloudy4SpriteMoveFinished(CCNode *sender)
{
    CCSprite *cloud1Sprite = (CCSprite *)sender;
    float bgSpritespx = cloud1Sprite->getTextureRect().getMaxX();
    CCSize size = CCDirector::sharedDirector()->getWinSize(); // 屏幕大小
